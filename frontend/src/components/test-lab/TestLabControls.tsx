...
const VISUAL_MODE_OPTIONS: Array<{
  ...
  },
  {
    ...
    summary: "Adjacent A/B scenes alternate rapidly.",
    description: "Cuts back and forth between two back-to-back scenes on a steady rhythm to simulate simple animation without generating a video clip.",
