...
export default function IdeationPage({ onUseIdea, initialNiche, initialIdeas, autoGenerateNiche }: Props) {
  ...
  useEffect(() => {
    if (autoGenerateNiche && !hasAutoGenerated.current) {
      hasAutoGenerated.current = true;
      inputRef.current?.setNiche(autoGenerateNiche);
      generate(autoGenerateNiche);
    }
  }, [autoGenerateNiche]); // eslint-disable-line react-hooks/exhaustive-deps
