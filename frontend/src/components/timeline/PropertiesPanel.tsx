...
import { Captions, Columns3, Film, Hash, Image, Images, PanelsTopLeft, Route } from "lucide-react";
...
export default function PropertiesPanel({
  ...
  const setVisualMode = (mode: VisualMode) => {
    const isLayered = mode === "popup_sequence" || mode === "comparison_board" || mode === "stat_card";
