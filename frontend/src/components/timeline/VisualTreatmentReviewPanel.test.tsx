...
describe("VisualTreatmentReviewPanel", () => {
  ...
  it("shows count badges for every visual mode", () => {
    ...
    expect(screen.getByLabelText("Full frame scenes")).toHaveClass("border-sky-400/60");
    expect(screen.getByLabelText("Full frame scenes")).toHaveClass("bg-sky-500/20");
    expect(screen.getByLabelText("Full frame scenes")).toHaveClass("text-yellow-200");
