...
function YouTubeShortsIcon({ filled, className = "w-3.5 h-3.5" }: { filled: boolean; className?: string }) {
  return (
    <svg
      className={`${className} ${filled ? "text-red-400" : "text-neutral-500"}`}
      viewBox="0 0 24 24"
                ...
                <div className="flex flex-wrap gap-2">
                  {([
                    ...
                    { key: "shortform_youtube" as const, label: "YouTube (Short)", icon: (filled: boolean) => (
                      <YouTubeShortsIcon filled={filled} />
                    )},
