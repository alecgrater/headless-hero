...
export default function ShortFormStatusPill({
  ...
  return (
    <button
      ...
      className="inline-flex h-7 shrink-0 items-center whitespace-nowrap text-xs px-4 bg-neutral-800 hover:bg-neutral-700 rounded-md text-neutral-300 transition-colors"
    >
