...
interface Props {
  ...
  onGenerateSavedIdeas: (niche: string) => void;
}

type DiscoverTab = "for-you" | "trending" | "whitespace" | "ideas";

export default function DiscoverPage({ onGenerateIdeas, onGenerateSavedIdeas }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      ...
      <div className={activeTab === "ideas" ? "block" : "hidden"}>
        <IdeaPage onGenerateIdeas={onGenerateSavedIdeas} />
      </div>
