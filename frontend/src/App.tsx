...
type View = "project-dashboard" | "ideation" | "script-generation" | "timeline" | "settings" | "discover";
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-app text-neutral-100 flex flex-col">
      ...
      {/* Main content area */}
      <main className={`flex-1 w-full ${view === "timeline" || view === "project-dashboard" || view === "settings" || view === "discover" ? "" : "px-6 py-8 max-w-4xl mx-auto"}`}>
        {view === "settings" && (
          <SettingsPage
