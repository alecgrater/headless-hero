...
6. Specialized modes should appear only when the scene has clear affordances:
   ...
   - flipflop: cropped-subject character/body-language A/B micro-animation.
...
- `flipflop`: cropped-subject character/body-language A/B micro-animation, such as talking mouth changes, head tilt, pointing, leaning, shrugging, pacing, holding an object, opening/closing, typing, stirring, sorting, or counting.
