...
FLIPFLOP_CUTOUT_REGISTRATION_VERSION = "alpha-mask-registration-v7"
...
def _compose_flipflop_state_sheet_source_prompt(*, state_a_prompt: str, state_b_prompt: str, scene_prompt: str) -> str:
    return "\n".join(
        [
            ...
            "Do not draw or write cell labels. Do not write State A, State B, A, B, left, right, first, second, labels, captions, letters, numbers, or any other text in the image.",
            ...
            "",
            "LEFT CELL direction only, not drawable text:",
            state_a_prompt.strip(),
            "",
            "RIGHT CELL direction only, not drawable text:",
