...
def gemini_enhance_thumbnail(
    ...
    if eli_frame_path:
        character_instruction = (
            ...
            "Make the character noticeably larger than the circle — head and shoulders should clearly "
            "extend beyond the circle edge (about 25-35%% overflow beyond the circle boundary). "
