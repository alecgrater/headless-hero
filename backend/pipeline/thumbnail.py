...
def gemini_enhance_thumbnail(
    ...
    if eli_frame_path:
        character_instruction = (
            ...
            "The character should be SIGNIFICANTLY larger than the circle — the circle acts as "
            "a portal he is emerging from. His head and upper body should extend well past the "
            "circle boundary (about 40-50%% overflow), with the circle sitting around his torso/waist area. "
